...
export default function LearnPage({ onNavigate }) {
  const guides = [
    ...
    {
      title: 'Guide to Ahmedabad Tech Ecosystem',
      category: 'Community Guide',
      readTime: '6 min read',
      description: 'Overview of tech hubs in SG Highway, Chandkheda, and Prahlad Nagar, student developer groups, and innovation incubators.'
    }
  ];

  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 space-y-10 font-sans">
      <div className="space-y-3 border-b border-slate-200 pb-8">
        ...
        <p className="text-base sm:text-lg text-slate-600 font-medium max-w-2xl">
          Guides, best practices, and resources for TechFest participants, student leaders, and event managers.
        </p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 font-sans">
        {guides.map((g, idx) => (
          <div key={idx} className="p-6 rounded-2xl bg-white border border-slate-200 space-y-3 flex flex-col justify-between">
            ...
            <button className="pt-2 text-xs font-mono font-bold text-indigo-700 flex items-center gap-1 hover:underline">
