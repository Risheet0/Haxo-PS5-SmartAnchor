...
We appreciate your patience and cooperation as we resume our scheduled program shortly."`;
  ...
  return (
    <div className="mx-4 sm:mx-6 mt-4 p-4 rounded-2xl bg-red-50/80 border border-red-200 shadow-sm animate-fade-in relative select-none">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <div className="flex items-start gap-3.5 max-w-4xl">
          ...
          <div className="space-y-1">
            <div className="flex flex-wrap items-center gap-2">
              <span className="px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider bg-red-600 text-white font-mono shadow-sm">
        ...
        {/* Right: Actions (Read as Anchor / Teleprompter, Copy, Dismiss) */}
        <div className="flex items-center gap-2 flex-shrink-0 self-end md:self-center">
          {onOpenTeleprompter && (
            <button
              onClick={handleReadInTeleprompter}
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-white hover:bg-slate-50 text-slate-700 border border-slate-200 text-xs font-medium transition shadow-sm"
